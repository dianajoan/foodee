             ...
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="d-flex">
                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                  ...
                  <li><a href="{{ route('terms') }}" class="py-2 d-block">Terms &amp; Conditions</a></li>
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+256 771991162</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@foodee.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
